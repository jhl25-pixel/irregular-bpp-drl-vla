...
def apply_conveyor_force(model, data, xml_path, conveyor_speed=1.0, force_magnitude=10.0):
    ...
    """
    # 获取传送带范围
    conveyor_min, conveyor_max = utils.return_conveyor_range(xml_path)
...
if __name__ == "__main__":
    set_the_size_of_the_conveyor(r"G:\irregularBPP\env\franka_emika_panda\conveyor.xml", x_size=3)